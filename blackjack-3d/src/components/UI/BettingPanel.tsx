...
export const BettingPanel = () => {
  ...
  return (
    <div className="betting-panel">
      <div className="betting-panel-content">
        {/* Left Section: Balance */}
        <div className="betting-panel-left">
        ...
        {/* Center Section: Chips or Messages */}
        <div className="betting-panel-center">
          {isBankrupt ? (
